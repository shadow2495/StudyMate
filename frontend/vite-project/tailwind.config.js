  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'accent-gradient': 'linear-gradient(135deg, #701a75 0%, #a21caf 50%, #c026d3 100%)',
        'hero-gradient': 'linear-gradient(135deg, #020617 0%, #0f172a 25%, #1e293b 50%, #334155 75%, #475569 100%)',
        'card-gradient': 'linear-gradient(145deg, rgba(30, 41, 59, 0.5) 0%, rgba(51, 65, 85, 0.3) 100%)',

      ...
      <div className="max-w-md w-full space-y-8 relative z-10">
        ...
        <div className="glass-intense p-10 rounded-3xl animate-fade-in-up shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {/* Terms Agreement */}
            <div className="flex items-start animate-fade-in-up" style={{animationDelay: '1s'}}>
              <input
                type="checkbox"
                id="agreeToTerms"
                name="agreeToTerms"
          ...
          {/* Divider */}
          <div className="my-6 flex items-center animate-fade-in-up" style={{animationDelay: '1.4s'}}>
          ...
          {/* Social Login */}
          <div className="grid grid-cols-2 gap-4 mb-6 animate-fade-in-up" style={{animationDelay: '1.6s'}}>

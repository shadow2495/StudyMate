  ...
  return (
    <div className="min-h-screen bg-hero-gradient flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-md w-full space-y-8 relative z-10">
        ...
        <div className="glass-intense p-10 rounded-3xl animate-fade-in-up shadow-2xl">
          {/* Header */}
          <div className="text-center mb-8">
            <div className="w-20 h-20 bg-primary-gradient rounded-3xl flex items-center justify-center mx-auto mb-6 shadow-glow animate-glow">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="animate-fade-in-up" style={{animationDelay: '0.4s'}}>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute inset-y-0 right-0 pr-3 flex items-center text-slate-400 hover:text-white transition-colors duration-300"
                >
                  {showPassword ? (
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full btn-primary disabled:opacity-50 disabled:cursor-not-allowed animate-fade-in-up"
          ...
          {/* Divider */}
          <div className="my-6 flex items-center animate-fade-in-up" style={{animationDelay: '1s'}}>
          ...
          {/* Social Login */}
          <div className="grid grid-cols-2 gap-4 mb-6 animate-fade-in-up" style={{animationDelay: '1.2s'}}>
            <button className="flex items-center justify-center px-4 py-3 glass rounded-xl hover:bg-white/10 transition-all duration-300 group">
